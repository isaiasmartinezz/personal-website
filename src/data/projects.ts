...
export const projects: Project[] = [
  ...
  },
  {
    ...
    imageAlt: "The assembled benchtop centrifuge prototype with its LCD control display reading \"Press Start To Begin\"",
    role: "Embedded Systems & Bioengineering Team Member",
    highlights: [
      "Integrated a fabricated rotor and tube holder, Arduino-based motor control, and optical RPM sensing into one working prototype.",
      "Designed phase-aware RGB status lighting and distinct start/completion audio cues so operators don't need to watch the device continuously.",
      "Solved an interrupt-safe firmware problem: moved blocking audio playback out of the start-button interrupt and into the main loop via an event flag.",
    ],
    links: [],
  },
  {
